...
* Язык оболочки командной строки (shell language) в Windows реализован в виде командных (или пакетных) файлов. Командный файл в Windows — это обычный текстовый файл с расширением bat или cmd, в котором записаны допустимые команды операционной системы (как внешние, так и внутренние), а также некоторые дополнительные инструкции и ключевые слова.^[1]^
  
* В Linux, так же как и в операционных системах семейства Microsoft Windows можно создавать командные файлы, которые содержат в себе набор команд интерпретатора shell. Такие файлы имеют свой синтаксис, который позволяет оперировать такими структурами как циклы и условия.^[2]^
...
-Посмотрим справку о tar

*Рисунок 1:*

![Посмотрим справку о tar](imagesforlw№11/image1.jpg)

*Рисунок 2:*

![Справка о tar](imagesforlw№11/image2.jpg)

-Создадим файл first.sh

*Рисунок 3:*

![Создаем файл](imagesforlw№11/image3.jpg)

-Откроем файл с помощью emacs.Напишем скрипт, соответствующий условию.

*Рисунок 4:*

![Откроем файл с помощью emacs](imagesforlw№11/image4.jpg)

*Рисунок 5:*

![Напишем скрипт, соответствующий условию](imagesforlw№11/image5.jpg)

-Сохраним изменения с помощь. Ctrl+X, Ctrl+s. после выйдем из файла, изменим его права доступа и сделаем проверку:
...
-Создадим файл second.sh и откроем его с помощью emacs

*Рисунок 7:*

![Создаем файл](imagesforlw№11/image7.jpg)

-Пишем пример командного файла согласно условию.

*Рисунок 8:*

![Заполняем файл](imagesforlw№11/image8.jpg)

-Меняем права доступа и вызываем файл.
...
![Вызываем файл как с числами, так и числами, превосходящими 10](imagesforlw№11/image10.jpg)
...
-Создадим файл third.sh и откроем его с помощью emacs

*Рисунок 11:*

![Создаем файл](imagesforlw№11/image11.jpg)
...
-Создадим файл fourth.sh и откроем его с помощью emacs

*Рисунок 14:*

![Создаем файл](imagesforlw№11/image14.jpg)
...
![Меняем права доступа и вызываем файл](imagesforlw№11/image16.jpg)

-Вводим формат файла и искомую директорию.
...
# Библиография
* [1] https://intuit.ru/studies/courses/1059/225/lecture/27287
* [2] https://sgww.livejournal.com/8836.html
